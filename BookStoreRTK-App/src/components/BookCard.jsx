...
export default function BookCard({ bk }) {
  const { id, thumbnail, featured, name, author, price, rating } = bk;
  const [deleteBook, { isError, isLoading, error }] = useDeleteBookMutation();
